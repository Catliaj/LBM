...
public class Overdue_Books extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Overdue_Books frame = new Overdue_Books();
	...
	public Overdue_Books() {
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Name", "Book Title", "Overdue Days", "Fine Amount", "Payment Status"
			}
		));
