...
public class Librarian_Login extends JFrame implements ActionListener
{
	...
	public Librarian_Login() {
		...
		librarianlbl.setForeground(new Color(57, 28, 11));
		librarianlbl.setFont(new Font("Lucida Sans", Font.BOLD, 25));
		librarianlbl.setBounds(35, 15, 147, 19);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getSource() == Login_btn)
		{
			...
			authentication.librarianLogin(username, password);
